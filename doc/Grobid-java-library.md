...
The Java artefacts of the latest GROBID release (0.9.0) are uploaded on a DIY repository. 
...
```
    implement 'org.grobid:grobid-core:0.9.0'
    implement 'org.grobid:grobid-trainer:0.9.0'
```
